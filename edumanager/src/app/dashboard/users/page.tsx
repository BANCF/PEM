...
import { Loader2, Users, Save, Shield, Edit3 } from "lucide-react";
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50/50 text-xs uppercase tracking-wider text-slate-500 border-b border-slate-100">
                    ...
                    <th className="p-4 font-semibold w-24 text-center">Lưu</th>
                  </tr>
                </thead>
                <tbody>
                  {users.map((user) => (
                    <tr key={user.id} className="border-b border-slate-50 hover:bg-blue-50/30 transition-colors">
                      ...
                      <td className="p-4 text-center">
                        {savingId === user.id ? (
                          ...
                          <span className="text-green-500 bg-green-50 p-2 rounded-lg inline-block opacity-0 group-hover:opacity-100 transition"><Save size={18}/></span>
                        )}
                      </td>
                    </tr>
                  ))}
